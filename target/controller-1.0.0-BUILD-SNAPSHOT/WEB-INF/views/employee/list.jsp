...
<%@ include file="../includes/header.jsp" %>
	...
	<div id="wrap" align="center">
		...
		<table class="list">
			...
			<tr>
				<th style="text-aligh:center;">아이디</th>
				<th style="text-aligh:center;">이름</th>
				<th style="text-aligh:center;">권한</th>
				<th style="text-aligh:center;">성별</th>
				<th style="text-aligh:center;">전화번호</th>
			</tr>
